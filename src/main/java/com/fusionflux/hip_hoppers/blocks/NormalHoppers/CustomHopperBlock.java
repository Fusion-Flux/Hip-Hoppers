...
public class CustomHopperBlock extends BlockWithEntity{
    ...
    public CustomHopperBlock(Settings settings, int itemMoveSpeed) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new CustomHopperBlockEntity(pos, state,this.transferSpeed);
    }

    @Nullable
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, HipHoppersBlocks.CUSTOM_HOPPER_BLOCK_ENTITY, CustomHopperBlockEntity::serverTick);
    }
