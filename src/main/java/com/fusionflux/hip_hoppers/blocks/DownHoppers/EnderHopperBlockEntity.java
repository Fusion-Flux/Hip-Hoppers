...
public class EnderHopperBlockEntity extends LootableContainerBlockEntity implements Hopper {
    ...
    public EnderHopperBlockEntity(BlockPos pos, BlockState state) {
        this(pos,state, 8);
    }

    public EnderHopperBlockEntity(BlockPos pos, BlockState state, int transferSpeed) {
        super(HipHoppersBlocks.ENDER_HOPPER_BLOCK_ENTITY,pos, state);
    ...
    public static void serverTick(World world, BlockPos pos, BlockState state, EnderHopperBlockEntity blockEntity) {
    ...
    private static boolean insertAndExtract(World world, BlockPos pos, BlockState state, EnderHopperBlockEntity blockEntity, BooleanSupplier booleanSupplier) {
        if (world.isClient) {
            return false;
        } else {
        ...
        if (canInsert(to, stack, slot, side)) {
            ...
            if (bl) {
                if (bl2 && to instanceof EnderHopperBlockEntity) {
                    EnderHopperBlockEntity hopperBlockEntity = (EnderHopperBlockEntity)to;
                    if (!hopperBlockEntity.isDisabled()) {
                        int j = 0;
                        if (from instanceof HopperBlockEntity) {
                            EnderHopperBlockEntity hopperBlockEntity2 = (EnderHopperBlockEntity)from;
    ...
    public static void onEntityCollided(World world, BlockPos pos, BlockState state, Entity entity, EnderHopperBlockEntity blockEntity) {
